# python main_dino.py --arch resnet50 --optimizer sgd --lr 0.03 --weight_decay 1e-4 --weight_decay_end 1e-4 --global_crops_scale 0.4 1 --local_crops_scale 0.05 0.4 --data_path /sddata/data/dmist/dmist_preprocessed_npys/preprocessed_newset_tensorflow3 --output_dir /sddata/projects/dmist_scott/dinov1/outputs
...
from npy_dataset import NpyImageFolder
import random
...
def get_args_parser():
    ...
    # Scott
    parser.add_argument("--cuda_num", default=0, type=int, help="Cuda num to use")
    return parser

def is_valid_npy(img_file_path):
    if img_file_path[-4:] == '.npy':
        return True
    return False
...
def train_dino(args):
    ...
    args.gpu = args.cuda_num
    print("manually setting args gpu: ", args.gpu)
    ...
    dataset = NpyImageFolder(args.data_path, is_valid_file=is_valid_npy, transform=transform)
